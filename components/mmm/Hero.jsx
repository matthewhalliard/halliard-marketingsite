  ...
  return (
    <Container className="pt-32 pb-16 text-center lg:pt-40">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Finally, an MMM That{' '}
        <span className="relative whitespace-nowrap text-[#1F3FFF]">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-[#1F3FFF]/30"
      ...
      <div className="mt-16 grid grid-cols-2 gap-4 sm:grid-cols-4 text-center">
        <div>
          <div className="text-4xl font-bold text-[#1F3FFF]">↗</div>
